% takes results from RODI_MainProcessing_062524.m and joins 35 the
% different experiments into one txt file with two additional columns
% specifying salt name and concentration
% 07/12/24
...
writetable(combinedData, 'allData_Unscored_092324.txt', 'Delimiter', '\t');
